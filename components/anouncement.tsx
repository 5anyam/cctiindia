...
export default function AnnouncementBar() {
  ...
  return (
    <div style={{ background: '#0A5BD6', color: '#fff', padding: '9px 16px', position: 'relative', overflow: 'hidden', transition: 'opacity 0.3s, transform 0.3s', opacity: isAnimating ? 0 : 1, transform: isAnimating ? 'translateY(-100%)' : 'translateY(0)' }}>
