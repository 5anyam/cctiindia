...
const coolerFAQs: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Simply WhatsApp us at +91 98100 37985 or call us. You can also visit our factory in Bawana Industrial Area, Delhi (Mon–Fri, 9 AM–7 PM). We accept online orders and ship pan-India.'
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes. We supply to dealers, contractors, housing societies, factories and institutions at wholesale rates. WhatsApp us at +91 98100 37985 with your requirements for a custom quote.'
  },
];
  ...
  return (
    <div style={{ background: '#fff', borderRadius: 16, border: `1.5px solid #dde8ff`, overflow: 'hidden', boxShadow: '0 2px 12px rgba(10,91,214,0.06)' }}>
      <div style={{ padding: '20px 28px', borderBottom: `1px solid #dde8ff`, background: '#f0f5ff' }}>
        ...
        <p style={{ fontSize: 12, color: 'rgba(11,30,61,0.74)', marginTop: 4 }}>Can&apos;t find an answer? WhatsApp us at +91 98100 37985</p>
      </div>
      <div>
